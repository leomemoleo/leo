...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="<?= ADMIN_URL ?>/brands/edit/<?= $brand['id'] ?>" enctype="multipart/form-data">
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="slug" name="slug"
                           value="<?= htmlspecialchars($brand['slug']) ?>" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="country" name="country"
                           value="<?= htmlspecialchars($brand['country'] ?? '') ?>"
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="sort_order" name="sort_order"
                           value="<?= $brand['sort_order'] ?? 0 ?>" min="0">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="is_active" name="is_active">
                        <option value="1" <?= $brand['is_active'] == 1 ? 'selected' : '' ?>>Aktif</option>
                        <option value="0" <?= $brand['is_active'] == 0 ? 'selected' : '' ?>>Pasif</option>
                    </select>
                </div>
            </div>
                ...
                <?php if (!empty($brand['logo'])): ?>
                    <div style="margin-bottom: 1rem;">
                        <img src="<?= BASE_URL ?>/<?= htmlspecialchars($brand['logo']) ?>"
                             ...
                             style="max-height: 100px; border: 1px solid #ddd; border-radius: 8px; padding: 0.5rem;">
                    </div>
                <?php endif; ?>
                <input type="file" class="form-control" id="logo" name="logo" accept="image/*">
                <small class="form-text">PNG veya JPG formatında, maksimum 2MB. Boş bırakırsanız mevcut logo değişmez.</small>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="meta_description" name="meta_description" rows="3"><?= htmlspecialchars($brand['meta_description'] ?? '') ?></textarea>
            </div>
